...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    pointer = (unsigned short *)mxGetPr(plhs[0]);
...
//     
//     // Create a local array and load data
//     dynamicData = (UINT16_T*)mxCalloc(elements, sizeof(UINT16_T));
// 
